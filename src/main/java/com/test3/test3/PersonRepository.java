...
public class PersonRepository {
	...
	public int createGroup(String leaderid,String groupid,String groupdate,String leadername,String groupName,String description)
	{
		...
		{          jdc.update("insert into coordinates(groupid,latlng)values(?,?);",groupid,null);
			return jdc.update("insert into volonteerGroups(leaderid,groupid,groupdate,groupname,description,leadername)values(?,?,?,?,?,?)"
					,leaderid,groupid,groupdate,groupName,description,leadername);
		}
	...
	public int insertIntoGroup(String volonteerid,String groupid)
	{
		...
		if(count==1)
			return jdc.update("update volonteers set groupid=? where volonteername=?",groupid,volonteerid);
		else return 0;
